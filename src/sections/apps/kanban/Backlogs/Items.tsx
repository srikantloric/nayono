...
// drag wrapper
const getDragWrapper = (isDragging: boolean, colorScheme: string | undefined, theme: Theme): CSSProperties | undefined => {
  const bgcolor =
    colorScheme === ThemeMode.DARK
      ? withAlpha(theme.vars.palette.background.paper, 0.9)
      : withAlpha(theme.vars.palette.primary.lighter, 0.99);
  return {
      ...
      {(provided, snapshot) => (
        <TableRow
          ...
          sx={(theme) => ({
            ...
            ...getDragWrapper(snapshot.isDragging, colorScheme, theme)
          })}
        >
