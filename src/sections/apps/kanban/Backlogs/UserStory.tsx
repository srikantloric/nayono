...
// drag wrapper
const getDragWrapper = (isDragging: boolean, colorScheme: string | undefined, theme: Theme, open: boolean): CSSProperties | undefined => {
  let bgcolor = 'transparent';
  if (open) {
    bgcolor = colorScheme === ThemeMode.DARK ? theme.vars.palette.background.default : theme.vars.palette.secondary.lighter;
  }

  if (isDragging) {
    bgcolor = colorScheme === ThemeMode.DARK ? theme.vars.palette.background.default : theme.vars.palette.primary.lighter;
  }
        ...
        {(provided, snapshot) => (
          <>
            <TableRow
              ...
              sx={(theme) => ({
                ...getDragWrapper(snapshot.isDragging, colorScheme, theme, open),
