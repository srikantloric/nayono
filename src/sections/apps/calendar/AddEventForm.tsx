...
export default function AddEventFrom({ event, range, onCancel, modalCallback }: AddEventFormProps) {
  ...
  const backgroundColor = [
    ...
    {
      value: colorScheme === ThemeMode.DARK ? 'primary.darker' : 'primary.lighter',
      color: colorScheme === ThemeMode.DARK ? 'primary.darker' : 'primary.lighter',
      isLight: true
    },
    {
      value: colorScheme === ThemeMode.DARK ? 'error.darker' : 'error.lighter',
      color: colorScheme === ThemeMode.DARK ? 'error.darker' : 'error.lighter',
      isLight: true
    },
    {
      value: colorScheme === ThemeMode.DARK ? 'success.darker' : 'success.lighter',
      color: colorScheme === ThemeMode.DARK ? 'success.darker' : 'success.lighter',
      isLight: true
    },
    {
      value: colorScheme === ThemeMode.DARK ? 'secondary.darker' : 'secondary.lighter',
      color: colorScheme === ThemeMode.DARK ? 'secondary.darker' : 'secondary.lighter',
      isLight: true
    },
    {
      value: colorScheme === ThemeMode.DARK ? 'warning.darker' : 'warning.lighter',
      color: colorScheme === ThemeMode.DARK ? 'warning.darker' : 'warning.lighter',
      isLight: true
    }
  ];
