    ...
    <Grid>
      <Tooltip title={colorsData.length && colorsData[0] && colorsData[0].label ? colorsData[0].label : ''}>
        <ButtonBase
          ...
          sx={{ borderRadius: '50%', '&:focus-visible': { outline: `2px solid secondary.dark`, outlineOffset: 2 } }}
        >
          <Avatar
            color="inherit"
            size="sm"
              ...
              <Stack sx={{ gap: 1, justifyContent: 'flex-end' }}>
                ...
                <Stack direction="row">
                  <TextField
                    ...
                    slotProps={{ htmlInput: { sx: { p: 1.75, width: '33%' } }, input: { sx: { borderRadius: 0 } } }}
                  />
                  <Stack>
                    <Button
                      key="one"
                      ...
                      sx={(theme) => ({
                        ...
                        '&.Mui-disabled': { borderLeft: 'none', borderColor: 'secondary.400' },

                        ...theme.applyStyles('dark', {
                          borderColor: 'secondary.200',
                          '&:hover': { borderColor: 'secondary.200' },
                          '&.Mui-disabled': { borderColor: 'secondary.200', '&:hover': { borderColor: 'secondary.200' } }
                        })
                      })}
                    >
                      <Add />
                    ...
                    <Button
                      ...
                      sx={(theme) => ({
                        ...
                        borderColor: 'secondary.400',
                        '&:hover': { borderColor: 'secondary.400' },
                        '&.Mui-disabled': { borderTop: 'none', borderLeft: 'none', borderColor: 'secondary.400' },
